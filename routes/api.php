        ...
        use App\Http\Controllers\CompanySubAdminController;
        ...
        Route::middleware('auth:sanctum')->group(function () {
            ...
            Route::middleware('role:owner,seg_subadmin,company_subadmin')->group(function () {
                ...
                Route::post('unassign-product-to-company', [CompanyController::class, 'unassignProductFromCompany']);


                Route::post('assign-lens_material_to_company', [AssignLensMaterial::class, 'AssignLensMaterialToCompany']);
                Route::post('unassign-lens_material_to_company', [AssignLensMaterial::class, 'unassignLensMaterialFromCompany']);
                Route::post('assign-scratch_coating-to-company', [AssignScratchCoating::class, 'assignScratchCoatingToCompany']);
                Route::post('unassign-scratch_coating-to-company', [AssignScratchCoating::class, 'unassignScratchCoatingFromCompany']);

                Route::post('assign-lens_tint-to-company', [AssignLenstint::class, 'assignLensTintToCompany']);
                Route::post('unassign-lens_tint-to-company', [AssignLenstint::class, 'unassignLensTintFromCompany']);


                Route::post('assign-lens_protection-to-company', [AssignLensProtection::class, 'assignLensProtectionToCompany']);
                Route::post('unassign-lens_protection-to-company', [AssignLensProtection::class, 'unassignLensProtectionFromCompany']);

                Route::post('assign-blue_light_protection-to-company', [AssignBlueLightProtection::class, 'assignBlueLightProtectionToCompany']);
                Route::post('unassign-blue_light_protection-to-company', [AssignBlueLightProtection::class, 'unassignBlueLightProtectionFromCompany']);
                ...
                Route::post('unassign-company_lens_type_subcategories-to-company', [LensTypeSubcategoriesController::class, 'unassignLensTypeSubcategoriesFromCompanies']);
